...
$row_sk_mengajar = mysqli_query($conn,"SELECT * FROM tb_pengajuan WHERE jns_sp ='skmengajar' AND status=4");
$jumlah_sk_mengajar = mysqli_num_rows($row_sk_mengajar);


$row_sk_magang = mysqli_query($conn, "SELECT * FROM tb_pengajuan WHERE jns_sp ='skmagang' AND status=4");
$jumlah_sk_magang = mysqli_num_rows($row_sk_magang);


$row_sk_doswal = mysqli_query($conn,"SELECT * FROM tb_pengajuan WHERE jns_sp ='skdoswal'AND status=4");
$jumlah_sk_doswal = mysqli_num_rows($row_sk_doswal);

$row_sk = mysqli_query($conn,"SELECT * FROM tb_pengajuan WHERE status=4");
