...
<?php
// upload file xls
$target = basename($_FILES['lampiranskm']['name']) ;
move_uploaded_file($_FILES['lampiranskm']['tmp_name'], $target);

// beri permisi agar file xls dapat di baca
chmod($_FILES['lampiranskm']['name'],0777);

// mengambil isi file xls
$data = new Spreadsheet_Excel_Reader($_FILES['lampiranskm']['name'],false);
...
for ($i=2; $i<=$jumlah_baris; $i++){
  ...
  $sks10 = $data->val($i, 53);
	...
	if($nm_dosen != "" OR $nidn != "" OR $nip_dis != "" OR $matkul1 != "" OR $matkul2 != "" OR $matkul3 != "" OR $matkul4 != "" OR $matkul5 != "" OR $matkul6 != "" OR $matkul7 != "" OR $matkul8 != "" OR $matkul9 != "" OR $matkul10 != "" OR $prodi1 != "" OR $prodi2 != "" OR $prodi3 != "" OR $prodi4 != "" OR $prodi5 != "" OR $prodi6 != "" OR $prodi7 != "" OR $prodi8 != "" OR $prodi9 != "" OR $prodi10 != "" OR $kelas1 != "" OR $kelas2 != "" OR $kelas3 != "" OR $kelas4 != "" OR $kelas5 != "" OR $kelas6 != "" OR $kelas7 != "" OR $kelas8 != "" OR $kelas9 != "" OR $kelas10 != "" OR $sks_matkul1 != "" OR $sks_matkul2 != "" OR $sks_matkul3 != "" OR $sks_matkul4 != "" OR $sks_matkul5 != "" OR $sks_matkul6 != "" OR $sks_matkul7 != "" OR $sks_matkul8 != "" OR $sks_matkul9 != "" OR $sks_matkul10 != "" OR $sks1 != "" OR $sks2 != "" OR $sks3 != "" OR $sks4 != "" OR $sks5 != "" OR $sks6 != "" OR $sks7 != "" OR $sks8 != "" OR $sks9 != "" OR $sks10 != ""){
		...
		mysqli_query($conn,"INSERT into lam_skm values('','$nm_dosen', '$nidn', '$nip_dis', '$matkul1', '$matkul2', '$matkul3', '$matkul4', '$matkul5', '$matkul6', '$matkul7', '$matkul8', '$matkul9', '$matkul10', '$prodi1', '$prodi2', '$prodi3', '$prodi4', '$prodi5', '$prodi6', '$prodi7', '$prodi8', '$prodi9', '$prodi10', '$kelas1', '$kelas2', '$kelas3', '$kelas4', '$kelas5', '$kelas6', '$kelas7', '$kelas8', '$kelas9', '$kelas10', '$sks_matkul1', '$sks_matkul2', '$sks_matkul3', '$sks_matkul4', '$sks_matkul5', '$sks_matkul6', '$sks_matkul7', '$sks_matkul8', '$sks_matkul9', '$sks_matkul10', '$sks1', '$sks2', '$sks3', '$sks4', '$sks5', '$sks6', '$sks7', '$sks8', '$sks9', '$sks10')");
		$berhasil++;
	}
}

// hapus kembali file .xls yang di upload tadi
unlink($_FILES['lampiranskm']['name']);

// alihkan halaman ke index.php
header("location:import_skm.php?berhasil=$berhasil");
?>