...
<div class="wrapper">
    <?php    include '../AdminLTE/AdminLTE/header.php'; ?>
    <?php    include '../AdminLTE/AdminLTE/sidebar.php'; ?>
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Form Data User</h3>
                  ...
                  <form action="simpan_user.php" method="POST" class="forms-sample" enctype="multipart/form-data">
                    ...
                    <button class="btn btn-light" action="tabel_user.php">Cancel</button>
                  </form>
  ...
  <!-- /.content-wrapper -->
  <?php    include '../AdminLTE/AdminLTE/footer.php'; ?>
