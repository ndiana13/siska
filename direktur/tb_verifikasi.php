          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php                    
                ...
                $sql = "SELECT * FROM tb_sk_mengajar WHERE status=2 ";
                ...
                while($d = mysqli_fetch_array($result)) {
                  if ($d['status']=='1'){
                    ...
                    <tr>
                      ...
                      <td>
                        <div><a class="btn btn-outline-success" href="accept_direktur.php?id_sk_mengajar=<?php echo $d['id_sk_mengajar']; ?>"><i class="fas fa-check"></i> ACCEPT</a></div>
                        <div><a class="btn btn-outline-danger" onclick="return confirm('Anda yakin ingin menolak item ini ?'" href="decline_direktur.php?id_sk_mengajar=<?php echo $d['id_sk_mengajar']; ?>" ><i class="fas fa-times"></i> DECLINE</a></div> 
