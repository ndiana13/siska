...
$id_sp = $_GET['id_sp'];
$query     =mysqli_query($conn, "SELECT * FROM tb_pengajuan  INNER JOIN tb_jurusan ON tb_pengajuan.id_jurusan = tb_jurusan.id_jurusan INNER JOIN tb_pengguna ON tb_pengajuan.nip = tb_pengguna.nip WHERE id_sp='$id_sp'");
	...
	<center>
		...
		<table>
			<tr class="text2">
				...
				<td width="20"><span>:</span><td>
				<td width="480" style="text-transform:uppercase;">Keputusan direktur politeknik negeri cilacap tentang <?php echo $result['perihal'];?> JURUSAN <?php echo $result['nm_jurusan'];?> Semester <?php echo $result['semester'];?> Tahun Akademik <?php echo $result['thn_akademik'];?>.</td>
			</tr>		
		</table>
		<table>
			<tr class="text2">
		...
		$r    =mysqli_fetch_array($sql);?><?php echo $r['nama_lengkap'];?></span><br><?php echo $r['nip'];?></td>
	     ...
	     <div style="page-break-before:always;">
	     	<table width="700">
				...
				<tr style="font-size: 10px;">
					<td width="300"></td>
					<td>Tentang : <?php echo $result['perihal'];?> Semester <?php echo $result['semester'];?> Jurusan <?php echo $result['nm_jurusan'];?> Tahun Akademik <?php echo $result['thn_akademik'];?>
					<td>
				</tr>
			</table><br><br>		
			<table width="700">
				<tr>
					...
					<center>
						...
						PADA JURUSAN <?php echo $result['nm_jurusan'];?> SEMESTER <?php echo $result['semester'];?><br>
