                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group btn-group-sm">
                          <a href="accept_wadir.php?id_sp=<?php echo $d['id_sp']; ?>" class="btn btn-info" onclick="return confirm('Anda yakin ingin menerima pengajuan ini ?')"><i class="fas fa-check"></i> Terima</a>
                          <a href="decline_wadir.php?id_sp=<?php echo $d['id_sp']; ?>" class="btn btn-danger" onclick="return confirm('Anda yakin ingin menolak pengajuan ini ?')"><i class="fas fa-times"></i>Tolak</a>
                        </div>
                      </td>
                      <td>
